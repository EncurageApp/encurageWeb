      ...
      <div className="home-app-icons">
        <div className="icons">
          <div className="icon-1">
            ...
            <p>
              ...
              deserves. With Tailored for Your Child, you'll have the power to
              create a unique healthcare plan that caters to your child's
              individual needs. Start now and make their well-being a top
              priority.
            </p>
          </div>
        </div>
        <div className="icons">
          <div className="icon-2">
            ...
            <p>
              ...
              managing multiple tools. Explore now to experience the convenience
              of having everything you need for your child's health in one
              place.
            </p>
          </div>
        </div>
        <div className="icons">
          <div className="icon-3">
            <h3>Pediatricians' Seal of Approval</h3>
            <button className="cta-btn-home">
