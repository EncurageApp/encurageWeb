...
export const Faq = () => {
  ...
  return (
    <>
      <Helmet>
        <title>FAQ | Encurage</title>
        <meta
          name="description"
          content="Answers to the most popular questions"
        />
        ...
        />
        <meta property="og:url" content="https://encurage.app/helpcenter/Faq" />
      ...
      <main className="faq-page">
        <p>
          ...
          <br />
          <br />
          If you have more questions, tap the “Contact Us” button to chat with
          us.
        </p>
        ...
        <div className="faq-collapse">
          ...
          <Collapsible trigger={<div>What is the Encurage app about?</div>}>
            <div>
              <p>
                We developed Encurage to help parents (and other caregivers)
                care for their children safely, and efficiently.
                <br />
                Managing your child's health is a dynamic and challenging
                journey, with many unique aspects. We put extensive research and
                work into addressing your specific and ever evolving needs.
                <br />
                <br />
          ...
          <Collapsible
            trigger={
              <div>Does Encurage provide medical advice or services?</div>
            }
          >
            <p>
              No. We are strictly a management tool for the life in between
              doctors’ visits, and do not have any connection to, nor do we
              offer, any medical advice or services of any kind. Please read our
              Terms and Conditions for more details.
            </p>
          </Collapsible>
          <Collapsible
            trigger={
              <div>How do you handle the data collected by the app?</div>
            }
          >
            <p>
          ...
          >
            <p>
              Tap the “Contact Support” option on your settings menu, and send
              us a message whenever you have any questions, or if you are
          ...
          <Collapsible
            trigger={
              <div>
                I have a feature request for future releases; or I want to
                provide some feedback. Who should I contact?
              </div>
            }
          >
            <p>
              ...
              feedback from our users means the world to us! It enables us to
              keep enhancing the app in alignment with parents’ needs. We read
              and address all feedback and feature requests.
            </p>
          </Collapsible>
          ...
          >
            <p>
              ...
              reopening it. In all other cases, you can either: use your email
              and password; or log in through Google or Apple, by tapping the
          ...
          <Collapsible trigger={<div>How can I edit my profile?</div>}>
            <p>
              ...
              apply edits made. You can also access your profile from the
              Settings menu.
            </p>
          </Collapsible>
          <Collapsible trigger={<div>Can I delete my account?</div>}>
            <p>
              Yes, you can delete your account through the “Delete Account”
              option on the settings menu of the app.You can also contact us
              through the “Contact Support” button to delete your account.
              Please note, that once your account is deleted, it cannot be
              restored.
            </p>
          </Collapsible>
          <Collapsible trigger={<div>Can I delete my data?</div>}>
            <p>
              If you are interested in deleting all of your data from our
              servers, please contact us through the Contact Support option on
              the settings menu. We will process your request within a
              reasonable time. Some auto-collected, technical and
              non-identifiable data may remain on our servers. Please read our
              Privacy Policy for complete details. Please note, that once your
          ...
          >
            <p>
              ...
              and updating it periodically, because many dosages are based on
              your child’s current weight. Having it available on the app is one
          ...
          <Collapsible trigger={<div>How do I cancel my subscription?</div>}>
            <p>
              You can cancel your subscription at any time, without contacting
              us, through your Apple ID (for iOS users), or your Google Play
              account (for android users). Please note that we are unable to
              cancel your subscription for you, and the only way to do so is
              through your device. For additional details, please read our Terms
              and Conditions.
            </p>
          </Collapsible>
          ...
          <Collapsible
            trigger={
              <div>
                What is the purpose of the As-needed Wizard? Why is it a
                separate feature?
              </div>
            }
          >
            <p>
              ...
              <br />
              We developed this feature to address the specific and unique
              aspects of as-needed medicine management, such as: calculating the
              right time gaps and timing of future doses; switching between
              acetaminophen and ibuprofen; alternating them if recommended; the
              dynamic nature of a fever/sickness episode that sometimes results
              in pausing and resuming medication; and many others.
              <br />
              ...
              medications and treatments, please use the Everything On a
              Schedule feature.
            </p>
          </Collapsible>
          <Collapsible
          ...
          >
            <p>
              ...
              one-time, short process, done at the beginning of the first
              Episode you manage with Encurage. We want you to have the
              flexibility during Episodes to switch from acetaminophen to
              ibuprofen, or the other way around; to switch to alternating both;
              or from alternating both to giving one of them.
              <br />
          ...
          <Collapsible
            trigger={
              <div>
                I’m alternating acetaminophen and ibuprofen and want to switch
                to giving only one of them.
                <br />
                <br />
                OR
                <br />
          ...
          <Collapsible
            trigger={
              <div>
                I need to update my child’s dosage of an as-needed medication.
                How do I do that?
              </div>
            }
          >
            <p>
              ...
              your child’s profile. Tap “Save” when you're done to apply the
              edits made. Edited dosages will apply automatically to medicine
              schedules.
            </p>
          </Collapsible>
          <Collapsible
          ...
          >
            <p>
              You can type the medicine name to add it manually, and then
              continue to set the schedule.
            </p>
          </Collapsible>
          <Collapsible
            trigger={
          ...
          >
            <p>
              You will get a total of 4 reminders for each dose. To delay a
              dose, tap the “Snooze” button and choose the right option for you.
            </p>
          </Collapsible>
          <Collapsible
          ...
          >
            <p>
              ...
              stop sending them and keep the schedule paused until it’s the
              right time for you to resume it. When you’re ready to resume, the
              schedule will auto update for future doses.
            </p>
          </Collapsible>
          <Collapsible trigger={<div>Can I pause the schedule?</div>}>
            <p>
              Yes, you can do that through the edit button available on the top
              right corner of the schedule. Reminders will be paused until
              you’re ready to resume, and the schedule will auto update for
              future doses.
              <br />
              If you’re managing an episode of two as-needed medications, that
              are not acetaminophen or ibuprofen, you also have the option of
              pausing one of them, and resuming when you’re ready.
            </p>
          </Collapsible>
          <Collapsible
            trigger={
              <div>
                I accidentally tapped “Dose Given”, can I edit the
                administration time of a single dose?
              </div>
            }
          >
            <p>
          ...
          >
            <p>
              Medications that are not given orally, such as creams or
              injections, are applied to different parts of the body. For
              example, cream application sites can change; and many injections’
              directions of use require rotating the injection site.
              <br />
              If you are giving your child a medication of this kind (rather
              than an oral medication or a suppository), consider utilizing the
          ...
          <Collapsible
            trigger={
              <div>
                I just want to track some occasional doses I give my child
                without managing a schedule. How do I do that?
              </div>
            }
          >
            <p>
          ...
          >
            <p>
              When your child is getting a treatment with a final number of
              doses - antibiotics is a good example - please choose the
              short-term schedule option for the most useful experience. The
              doses on this schedule are marked numerically, so that you can
              verify all required doses were given. There is also a special
              adaptation for missed doses (see below - “what happens to the
              schedule if I didn’t respond to any of the 4 reminders?”).
              <br />
              For any medicine, supplement or other treatment given to your
              child on an ongoing basis, without a definite ending date, please
              choose the ongoing schedule option.
            </p>
          </Collapsible>
          <Collapsible
            trigger={
          ...
          >
            <p>
              For short-term schedules: you will be asked to choose between
              “Give the dose now” when you open the schedule, or “skip and add
              to end”. Both choices ensure that the total number of doses is
              retained. Please choose in accordance with your provider’s or
              pharmacist’s instructions. For ongoing schedules: you will be
              asked to choose between “Give the dose now” or “skip”. Please
              choose in accordance with your provider’s or pharmacist’s
              instructions.
            </p>
          </Collapsible>
          <Collapsible
            trigger={
              <div>
                How do I edit the dose; reminder times; or any other value on
                the schedule?
              </div>
            }
          >
          ...
          <Collapsible trigger={<div>Can I pause the schedule?</div>}>
            <p>
              Yes, you can do that from the edit button available on the top
              right corner of the schedule. Reminders will be paused until
          ...
          >
            <p>
              ...
              schedule. Please note, that editing the timing of a given dose
              will not change the timing of future doses on that schedule.
            </p>
          </Collapsible>
          <Collapsible
            trigger={
              <div>
                I gave my child some doses before adding the schedule on the
                app. How do I track those?
              </div>
            }
          >
            <p>
          ...
          >
            <p>
              There is no limit on the number of people you can add as care
              family members. We know it takes a village! You can easily edit
              the care family and remove certain members if needed.
            </p>
          </Collapsible>
          <Collapsible
            trigger={
          ...
          >
            <p>
              ...
              login to other users’ accounts. All actions done on the app, and
              all recorded data, will be available simultaneously on all of the
          ...
          <Collapsible
            trigger={<div>How do I remove a Care Family Member?</div>}
          >
            <p>
          ...
          >
            <p>
              If the data does not immediately show on your account after you
              have successfully entered your code, please try logging out of
              your account from the settings menu, or by force closing the app,
              and then logging in again. If the issue persists, please contact
              us through the “Contact Support” button on the app.
            </p>
          </Collapsible>
          ...
          >
            <p>
              ...
              values among children. If a certain value is currently not
              included, you can tap “other” to add the name manually, and the
              rest of the tracking tools for that value will be available. We
              would also love to hear from you if there are values you would
              like to see added to our future releases. Drop us a line through
              the “Contact Support” button on the settings menu.
            </p>
          </Collapsible>
          <Collapsible trigger={<div>What are the folders?</div>}>
            <p>
              ...
              episodes.
              <br />
              If you’re not interested in creating separate folders, you can
              save all of the trackings under the default “General” folder.
            </p>
          </Collapsible>
          ...
          <Collapsible trigger={<div>How do I delete trackings?</div>}>
            <p>
              The edit button is available for each tracking category, and you
              can edit all values, including deletion of the entire tracking, at
              any time. Please note that once you delete a tracking, it cannot
              be restored.
            </p>
          </Collapsible>
          ...
          >
            <p>
              ...
              reaction to, and progress with, their treatment plan. While
              tracking symptoms and side effects plays an important role in
              helping the healthcare provider to diagnose and set a treatment
              plan, the Journal focuses on a variety of subjects that are
              considered as key factors of progress assessment, and helps both
              parents and healthcare providers to reshape and optimize their
          ...
          <Collapsible trigger={<div>What are the folders?</div>}>
            <p>
              ...
              health journeys. They allow quick access to separate aspects you
              may use the Journal for, such as separate ongoing conditions. If
              you’re not interested in creating separate folders, you can save
              all of the Stories under the default “General” folder.
            </p>
          </Collapsible>
