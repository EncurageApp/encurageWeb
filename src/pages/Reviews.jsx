...
export const Reviews = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Reviews | Encurage</title>
        <meta
          name="description"
          content="Read real reviews from parents like you"
        />
        ...
        />
        <meta property="og:url" content="https://encurage.app/Reviews" />
      ...
      <main className="review-page">
        ...
        <section className="review-container">
          ...
          <div data-aos="fade-left" className="review-box box-2">
            ...
            <div className="review-text">
              <p>
                "I love this app. I have two kids who are sick and as a single
                mom it’s not easy remembering everything. This app is good for
                documenting".
              </p>
            </div>
          </div>
          <div data-aos="fade-right" className="review-box box-3">
            ...
            <div className="review-text">
              <p>
                ...
                adjusted if he got a dose late due to a nap, but it was simple
                to use and keep track of everything. Recommending it to all my
                friends!"
              </p>
            </div>
          </div>
          ...
          <div data-aos="fade-right" className="review-box box-5">
            ...
            <div className="review-text">
              <p>
                "I have 3 sick kids right now, all different ages and weights.
                We are in the midst of stressful thanksgiving cross country
                travel trying to get home while all being ill. I was having the
                HARDEST time keeping track of what time I have each kid their
                last dose of medicine. This app has helped our family SO MUCH.
                Thank you for making something to help simplify a stressful time
                for our family. I like the app's layout and being able to track
                my children’s medicines and when they took them. It’s very
          ...
          <div data-aos="fade-left" className="review-box box-6">
            ...
            <div className="review-text">
              <p>
                ...
                takes the guess work out of what, how much and when! I ran into
                a few issues which were quickly met with a very fast response
                via email I’ve recommended this app to several moms and will
                continue to".
              </p>
            </div>
          </div>
          <div data-aos="fade-right" className="review-box box-7">
            ...
            <div className="review-text">
              <p>
                "If you have any children or people you are caring for and/or
                have a spouse or other caregiver who wants/needs to stay up to
                date, especially during illness and need to stay on track, you
                need this. Every parent needs this app!".
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="review-info">
          ...
          <p>
            ...
            feedback you’d like to share? We would love to hear from you. Your
            valuable input helps us keep improving encurage.
          </p>
