...
export const ChildMedicationManagement = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Challenges and risks | Encurage</title>
        <meta
          name="description"
          content="Tap to learn about the unique challenges and risks related to kids' medicine management"
        />
        ...
        <meta
          property="og:url"
          content="https://encurage.app/ChildMedicationManagement"
        />
      ...
      <main className="health-page">
        <section className="ch-hero-container">
          ...
          <div className="ch-hero-container-text">
            ...
            <p data-aos="fade-in" data-aos-delay="700">
              ...
              family members or caregivers; and more than one child means yet
              more responsibilities, with each child having their own specific
              needs.
              <br />
              <br />
          ...
          <div className="ch-card-wrapper">
            ...
            <div className="ch-stats-card">
              ...
              <div className="ch-card-content">
                ...
                <p>
                  - a parent or caregiver in the US makes a medication error
                </p>
              </div>
            </div>
            <div className="ch-stats-card">
              ...
              <div className="ch-card-content">
                ...
                <p>
                  of errors related to fever reducers, cough and cold
                  medications
                </p>
              </div>
            </div>
        ...
        <section data-aos="fade-in" className="ch-revision-text">
          <p>
            These data are some of the findings of Nationwide Children's
            Hospital in Columbus, Ohio, in a research conducted with the
        ...
        <section className="ch-reason-container">
          <div data-aos="fade-in">
            ...
            <p>
              ...
              Children’s Hospital research, as well as the AAP’s published
              policy.{" "}
            </p>
          </div>
          <ul>
            ...
            <li>
              <HealthCollapsible label="Tiredness and Stress">
                ...
                <div>
                  <p>
                    Caring for a sick child through the night. Juggling care
                    with work and other commitments. Worrying for your child's
                    health. Confusion is almost inevitable.
                  </p>
                  <Link to="/MedicationManagementTools" onClick={handleLink}>
                    <button className="cta-btn-home">
                      Explore Our Solutions
            ...
            <li>
              <HealthCollapsible label="Young Children">
                ...
                <div>
                  <p>
                    Their weight, and as a result their medications’ dosages,
                    keep updating frequently. Parents need to navigate a
